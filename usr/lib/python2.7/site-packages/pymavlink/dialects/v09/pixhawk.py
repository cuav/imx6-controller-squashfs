...
MAVLINK_MSG_ID_VISION_POSITION_ESTIMATE = 156
MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE = 157
MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE = 158
MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_SET = 159
MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET = 160
...
class MAVLink_set_cam_shutter_message(MAVLink_message):
        ...
        ordered_fieldnames = [ 'cam_no', 'cam_mode', 'trigger_pin', 'interval', 'exposure', 'gain' ]
        format = '>BBBHHf'
        native_format = bytearray('>BBBHHf', 'ascii')
        orders = [0, 1, 2, 3, 4, 5]
        lengths = [1, 1, 1, 1, 1, 1]
...
class MAVLink_image_available_message(MAVLink_message):
        ...
        ordered_fieldnames = [ 'cam_id', 'cam_no', 'timestamp', 'valid_until', 'img_seq', 'img_buf_index', 'width', 'height', 'depth', 'channels', 'key', 'exposure', 'gain', 'roll', 'pitch', 'yaw', 'local_z', 'lat', 'lon', 'alt', 'ground_x', 'ground_y', 'ground_z' ]
        format = '>QBQQIIHHHBIIfffffffffff'
        native_format = bytearray('>QBQQIIHHHBIIfffffffffff', 'ascii')
...
class MAVLink_position_control_setpoint_set_message(MAVLink_message):
        '''
        Message sent to the MAV to set a new position as reference for
        the controller
        '''
        id = MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_SET
        name = 'POSITION_CONTROL_SETPOINT_SET'
        fieldnames = ['target_system', 'target_component', 'id', 'x', 'y', 'z', 'yaw']
        ordered_fieldnames = [ 'target_system', 'target_component', 'id', 'x', 'y', 'z', 'yaw' ]
        format = '>BBHffff'
        native_format = bytearray('>BBHffff', 'ascii')
        orders = [0, 1, 2, 3, 4, 5, 6]
        lengths = [1, 1, 1, 1, 1, 1, 1]
        array_lengths = [0, 0, 0, 0, 0, 0, 0]
        crc_extra = 218

        def __init__(self, target_system, target_component, id, x, y, z, yaw):
                MAVLink_message.__init__(self, MAVLink_position_control_setpoint_set_message.id, MAVLink_position_control_setpoint_set_message.name)
                self._fieldnames = MAVLink_position_control_setpoint_set_message.fieldnames
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 218, struct.pack('>BBHffff', self.target_system, self.target_component, self.id, self.x, self.y, self.z, self.yaw))

class MAVLink_position_control_offset_set_message(MAVLink_message):
        '''
        Message sent to the MAV to set a new offset from the currently
        controlled position
        '''
        id = MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET
        name = 'POSITION_CONTROL_OFFSET_SET'
        ...
        def __init__(self, target_system, target_component, x, y, z, yaw):
                MAVLink_message.__init__(self, MAVLink_position_control_offset_set_message.id, MAVLink_position_control_offset_set_message.name)
                self._fieldnames = MAVLink_position_control_offset_set_message.fieldnames
                self.target_system = target_system
                self.target_component = target_component
                self.x = x
                self.y = y
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 115, struct.pack('>BBffff', self.target_system, self.target_component, self.x, self.y, self.z, self.yaw))
...
class MAVLink_position_control_setpoint_message(MAVLink_message):
        ...
        ordered_fieldnames = [ 'id', 'x', 'y', 'z', 'yaw' ]
        format = '>Hffff'
        native_format = bytearray('>Hffff', 'ascii')
        orders = [0, 1, 2, 3, 4]
        lengths = [1, 1, 1, 1, 1]
...
class MAVLink_marker_message(MAVLink_message):
        ...
        ordered_fieldnames = [ 'id', 'x', 'y', 'z', 'roll', 'pitch', 'yaw' ]
        format = '>Hffffff'
        native_format = bytearray('>Hffffff', 'ascii')
        orders = [0, 1, 2, 3, 4, 5, 6]
        lengths = [1, 1, 1, 1, 1, 1, 1]
        array_lengths = [0, 0, 0, 0, 0, 0, 0]
        crc_extra = 136
...
class MAVLink_raw_aux_message(MAVLink_message):
        ...
        ordered_fieldnames = [ 'adc1', 'adc2', 'adc3', 'adc4', 'vbat', 'temp', 'baro' ]
        format = '>HHHHHhi'
        native_format = bytearray('>HHHHHhi', 'ascii')
        orders = [0, 1, 2, 3, 4, 5, 6]
        lengths = [1, 1, 1, 1, 1, 1, 1]
        array_lengths = [0, 0, 0, 0, 0, 0, 0]
        crc_extra = 140
...
class MAVLink_watchdog_process_info_message(MAVLink_message):
        ...
        ordered_fieldnames = [ 'watchdog_id', 'process_id', 'name', 'arguments', 'timeout' ]
        format = '>HH100s147si'
        native_format = bytearray('>HHcci', 'ascii')
        orders = [0, 1, 2, 3, 4]
        lengths = [1, 1, 1, 1, 1]
        array_lengths = [0, 0, 100, 147, 0]
        crc_extra = 110
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 110, struct.pack('>HH100s147si', self.watchdog_id, self.process_id, self.name, self.arguments, self.timeout))
...
class MAVLink_watchdog_process_status_message(MAVLink_message):
        ...
        ordered_fieldnames = [ 'watchdog_id', 'process_id', 'state', 'muted', 'pid', 'crashes' ]
        format = '>HHBBiH'
        native_format = bytearray('>HHBBiH', 'ascii')
        orders = [0, 1, 2, 3, 4, 5]
        lengths = [1, 1, 1, 1, 1, 1]
        array_lengths = [0, 0, 0, 0, 0, 0]
        crc_extra = 92
...
class MAVLink_watchdog_command_message(MAVLink_message):
        ...
        ordered_fieldnames = [ 'target_system_id', 'watchdog_id', 'process_id', 'command_id' ]
        format = '>BHHB'
        native_format = bytearray('>BHHB', 'ascii')
        orders = [0, 1, 2, 3]
        lengths = [1, 1, 1, 1]
        array_lengths = [0, 0, 0, 0]
        crc_extra = 188
...
class MAVLink_pattern_detected_message(MAVLink_message):
        ...
        ordered_fieldnames = [ 'type', 'confidence', 'file', 'detected' ]
        format = '>Bf100sB'
        native_format = bytearray('>BfcB', 'ascii')
        orders = [0, 1, 2, 3]
        lengths = [1, 1, 1, 1]
...
class MAVLink_point_of_interest_message(MAVLink_message):
        ...
        ordered_fieldnames = [ 'type', 'color', 'coordinate_system', 'timeout', 'x', 'y', 'z', 'name' ]
        format = '>BBBHfff26s'
        native_format = bytearray('>BBBHfffc', 'ascii')
...
class MAVLink_point_of_interest_connection_message(MAVLink_message):
        ...
        ordered_fieldnames = [ 'type', 'color', 'coordinate_system', 'timeout', 'xp1', 'yp1', 'zp1', 'xp2', 'yp2', 'zp2', 'name' ]
        format = '>BBBHffffff26s'
        native_format = bytearray('>BBBHffffffc', 'ascii')
...
class MAVLink_data_transmission_handshake_message(MAVLink_message):
        ...
        fieldnames = ['type', 'size', 'packets', 'payload', 'jpg_quality']
        ordered_fieldnames = [ 'type', 'size', 'packets', 'payload', 'jpg_quality' ]
        format = '>BIBBB'
        native_format = bytearray('>BIBBB', 'ascii')
        orders = [0, 1, 2, 3, 4]
        lengths = [1, 1, 1, 1, 1]
        array_lengths = [0, 0, 0, 0, 0]
        crc_extra = 98

        def __init__(self, type, size, packets, payload, jpg_quality):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 98, struct.pack('>BIBBB', self.type, self.size, self.packets, self.payload, self.jpg_quality))
...
class MAVLink_brief_feature_message(MAVLink_message):
        ...
        ordered_fieldnames = [ 'x', 'y', 'z', 'orientation_assignment', 'size', 'orientation', 'descriptor', 'response' ]
        format = '>fffBHH32Bf'
        native_format = bytearray('>fffBHHBf', 'ascii')
        orders = [0, 1, 2, 3, 4, 5, 6, 7]
        lengths = [1, 1, 1, 1, 1, 1, 32, 1]
        array_lengths = [0, 0, 0, 0, 0, 0, 32, 0]
        crc_extra = 254
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 254, struct.pack('>fffBHH32Bf', self.x, self.y, self.z, self.orientation_assignment, self.size, self.orientation, self.descriptor[0], self.descriptor[1], self.descriptor[2], self.descriptor[3], self.descriptor[4], self.descriptor[5], self.descriptor[6], self.descriptor[7], self.descriptor[8], self.descriptor[9], self.descriptor[10], self.descriptor[11], self.descriptor[12], self.descriptor[13], self.descriptor[14], self.descriptor[15], self.descriptor[16], self.descriptor[17], self.descriptor[18], self.descriptor[19], self.descriptor[20], self.descriptor[21], self.descriptor[22], self.descriptor[23], self.descriptor[24], self.descriptor[25], self.descriptor[26], self.descriptor[27], self.descriptor[28], self.descriptor[29], self.descriptor[30], self.descriptor[31], self.response))
...
mavlink_map = {
        ...
        MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_SET : MAVLink_position_control_setpoint_set_message,
        MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET : MAVLink_position_control_offset_set_message,
...
class MAVLink(object):
        ...
        def position_control_setpoint_set_encode(self, target_system, target_component, id, x, y, z, yaw):
                '''
                Message sent to the MAV to set a new position as reference for the
                controller
                ...
                '''
                return MAVLink_position_control_setpoint_set_message(target_system, target_component, id, x, y, z, yaw)

        def position_control_setpoint_set_send(self, target_system, target_component, id, x, y, z, yaw):
                '''
                Message sent to the MAV to set a new position as reference for the
                controller
                ...
                '''
                return self.send(self.position_control_setpoint_set_encode(target_system, target_component, id, x, y, z, yaw))

        def position_control_offset_set_encode(self, target_system, target_component, x, y, z, yaw):
                '''
                Message sent to the MAV to set a new offset from the currently
                controlled position
                ...
                '''
                return MAVLink_position_control_offset_set_message(target_system, target_component, x, y, z, yaw)

        def position_control_offset_set_send(self, target_system, target_component, x, y, z, yaw):
                '''
                Message sent to the MAV to set a new offset from the currently
                controlled position
                ...
                '''
                return self.send(self.position_control_offset_set_encode(target_system, target_component, x, y, z, yaw))
        ...
        def data_transmission_handshake_encode(self, type, size, packets, payload, jpg_quality):
                '''
                ...
                '''
                return MAVLink_data_transmission_handshake_message(type, size, packets, payload, jpg_quality)

        def data_transmission_handshake_send(self, type, size, packets, payload, jpg_quality):
                '''
                ...
                '''
                return self.send(self.data_transmission_handshake_encode(type, size, packets, payload, jpg_quality))
